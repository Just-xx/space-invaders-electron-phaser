class EscapeMenuNode {
  constructor() {
    ...
    this.wrapper.classList.add("esc-menu-node-wrapper");

    // title nodes
    this.titleText = document.createElement("div");
    this.titleText.textContent = "Menu";
    this.titleText.classList.add("esc-menu-node-title");
    this.wrapper.appendChild(this.titleText);

    // btns nodes
    this.btnsWrapper = document.createElement("div");
    this.btnsWrapper.classList.add("esc-menu-node-btns-wrapper");
